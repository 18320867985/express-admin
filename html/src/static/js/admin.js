...
var components = [VueCheckbox, vueCheckboxGroup, VueCheckbtn, VueCheckbtnGroup, VueRadiobox, VueRadiobtn, VueSwitch, VueNumber, VueFile, VuePaging];
...
var bsHeader = {
  render: function render() {
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('header', [_c('navbar', { staticClass: "rd-no2 container-fuild", attrs: { "inverse": "", "fluid": "" } }, [_c('a', { staticClass: "navbar-brand rd-no2", attrs: { "slot": "brand", "href": "#" }, slot: "brand" }, [_vm._v("网站登录")]), _vm._v(" "), _c('template', { slot: "collapse" }, [_c('navbar-nav', { attrs: { "right": "" } }, [_c('li')])], 1)], 2)], 1);
  },
  staticRenderFns: []
  ...
  render: function render() {
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('div', { staticClass: "template-share user" }, [_c('div', { staticClass: "tab-slide", class: { 'active': _vm.tab.index } }, [_c('div', { staticClass: "btn-toolbar clearfix" }, [_c('div', { staticClass: "btn-group pull-left" }), _vm._v(" "), _c('div', { staticClass: "btn-group pull-right" }, [_c('button', { staticClass: "btn btn-default btn-sm", on: { "click": _vm.addBtn } }, [_c('span', { staticClass: "text-primary glyphicon glyphicon-plus" }), _vm._v(" 添加\n        ")]), _vm._v(" "), _c('button', { staticClass: "btn btn-default btn-sm", on: { "click": _vm.dtlBtn } }, [_c('span', { staticClass: "text-info glyphicon glyphicon-list-alt" }), _vm._v(" 查看\n        ")]), _vm._v(" "), _c('button', { staticClass: "btn btn-default btn-sm", on: { "click": _vm.editBtn } }, [_c('span', { staticClass: "glyphicon glyphicon-edit text-warning" }), _vm._v(" 修改\n        ")]), _vm._v(" "), _c('button', { staticClass: "btn btn-default btn-sm", on: { "click": function click($event) {
          ...
          return [_c('table', { staticClass: "table table-hover table-bordered" }, [_c('thead', [_c('tr', { staticClass: "text-center" }, [_c('th', [_c('vue-checkbox', { attrs: { "callback": scope.allChcek }, model: { value: scope.allcheckBtn.ck, callback: function callback($$v) {
              ...
              }, expression: "scope.allcheckBtn.ck" } })], 1), _vm._v(" "), _c('th', [_vm._v("编号")]), _vm._v(" "), _c('th', [_vm._v("用户名")]), _vm._v(" "), _c('th', [_vm._v("类型")]), _vm._v(" "), _c('th', [_vm._v("创建时间")])])]), _vm._v(" "), _c('tbody', _vm._l(scope.list, function (item, index) {
      ...
      return _c('option', { key: index, domProps: { "selected": _vm.editObj.roleId === _vm.item_id, "value": item._id } }, [_vm._v(_vm._s(item.name))]);
    }), 0)]), _vm._v(" "), _c('div', { staticClass: "form-group" }, [_c('button', { staticClass: "btn btn-primary", attrs: { "type": "submit", "disabled": _vm.editError } }, [_vm._v("保存")])])])]], 2)], 1), _vm._v(" "), _c('div', { staticClass: "tab-slide", class: { 'active': _vm.tab.add } }, [_c('vue-add', { attrs: { "cancel": _vm.addCancel, "url": _vm.httpUlr.add } }, [_c('template', { slot: "title" }, [_vm._v("添加用户信息")]), _vm._v(" "), [_c('form', { attrs: { "data-vv-scope": "add" }, on: { "submit": function submit($event) {
          $event.preventDefault();_vm.add('add');
        } } }, [_c('div', { staticClass: "form-group has-feedback", class: { ' has-error': _vm.errors.has('add.name') } }, [_c('label', { staticClass: "control-label", attrs: { "for": "add.name" } }, [_vm._v("用户名:")]), _vm._v(" "), _c('input', { directives: [{ name: "validate", rawName: "v-validate", value: { required: true, min: 4, unique: 'admin/user/data-unique' }, expression: "{required:true,min:4,unique:'admin/user/data-unique'}" }, { name: "model", rawName: "v-model", value: _vm.addObj.name, expression: "addObj.name" }], staticClass: "form-control", attrs: { "type": "text", "name": "add.name", "id": "add.name", "placeholder": "输入用户名" }, domProps: { "value": _vm.addObj.name }, on: { "input": function input($event) {
          if ($event.target.composing) {
            return;
          }_vm.$set(_vm.addObj, "name", $event.target.value);
        } } }), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.name:required'), expression: "errors.has('add.name:required')" }], staticClass: "text-danger" }, [_vm._v("用户名不为空！")]), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.name:min'), expression: "errors.has('add.name:min')" }], staticClass: "text-danger" }, [_vm._v("用户名最小长度为4位！")]), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.name:unique'), expression: "errors.has('add.name:unique')" }], staticClass: "text-danger" }, [_vm._v("用户名已存在！")])]), _vm._v(" "), _c('div', { staticClass: "form-group has-feedback", class: { 'has-error': _vm.errors.has('add.pwd') } }, [_c('label', { staticClass: "control-label", attrs: { "for": "pwd" } }, [_vm._v("密码:")]), _vm._v(" "), _c('input', { directives: [{ name: "model", rawName: "v-model", value: _vm.addObj.pwd, expression: "addObj.pwd" }, { name: "validate", rawName: "v-validate", value: { required: true, min: 8 }, expression: "{ required:true,min:8}" }], ref: "add.pwd", staticClass: "form-control", attrs: { "type": "password", "id": "pwd", "name": "add.pwd", "placeholder": "输入密码" }, domProps: { "value": _vm.addObj.pwd }, on: { "input": function input($event) {
          if ($event.target.composing) {
            return;
        ...
        } } }), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.pwd2:required'), expression: "errors.has('add.pwd2:required')" }], staticClass: "text-danger" }, [_vm._v("密码不为空！")]), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.pwd2:confirmed'), expression: "errors.has('add.pwd2:confirmed')" }], staticClass: "text-danger" }, [_vm._v("两次密码不相同！")])]), _vm._v(" "), _c('div', { staticClass: "form-group has-feedback", class: { 'has-error': _vm.errors.has('add.roleId') } }, [_c('label', { staticClass: "control-label", attrs: { "for": "roleId" } }, [_vm._v("用户类型:")]), _vm._v(" "), _c('select', { directives: [{ name: "model", rawName: "v-model", value: _vm.addObj.roleId, expression: "addObj.roleId" }, { name: "validate", rawName: "v-validate", value: 'required', expression: "'required'" }], staticClass: "form-control", attrs: { "name": "add.roleId", "id": "roleId" }, on: { "change": function change($event) {
          var $$selectedVal = Array.prototype.filter.call($event.target.options, function (o) {
            return o.selected;
          }).map(function (o) {
            var val = "_value" in o ? o._value : o.value;return val;
    ...
    })], 2), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.roleId:required'), expression: "errors.has('add.roleId:required')" }], staticClass: "text-danger" }, [_vm._v("用户类型不为空！")])]), _vm._v(" "), _c('div', { staticClass: "form-group has-feedback", class: { 'has-error': _vm.errors.has('add.email') } }, [_c('label', { staticClass: "control-label", attrs: { "for": "email" } }, [_vm._v("邮箱:")]), _vm._v(" "), _c('input', { directives: [{ name: "model", rawName: "v-model", value: _vm.addObj.email, expression: "addObj.email" }, { name: "validate", rawName: "v-validate", value: 'required|email', expression: "'required|email'" }], staticClass: "form-control", attrs: { "type": "text", "name": "add.email", "id": "email", "placeholder": "输入邮箱" }, domProps: { "value": _vm.addObj.email }, on: { "input": function input($event) {
          if ($event.target.composing) {
            return;
          }_vm.$set(_vm.addObj, "email", $event.target.value);
        } } }), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.eamil:required'), expression: "errors.has('add.eamil:required')" }], staticClass: "text-danger" }, [_vm._v("邮箱不为空！")]), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.email:email'), expression: "errors.has('add.email:email')" }], staticClass: "text-danger" }, [_vm._v("邮箱格式不对！")])]), _vm._v(" "), _c('div', { staticClass: "form-group" }, [_c('button', { staticClass: "btn btn-primary", attrs: { "type": "submit", "disabled": _vm.addError } }, [_vm._v("添加")])])])]], 2)], 1)]);
  },
  staticRenderFns: [],
  mixins: [mixin$1],
  data: function data() {
...
var App$3 = {
  render: function render() {
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('div', { staticClass: "template-share userrole" }, [_c('div', { staticClass: "tab-slide", class: { 'active': _vm.tab.index } }, [_c('div', { staticClass: "btn-toolbar clearfix" }, [_c('div', { staticClass: "btn-group pull-left" }), _vm._v(" "), _c('div', { staticClass: "btn-group pull-right" }, [_c('button', { staticClass: "btn btn-default btn-sm", on: { "click": _vm.addBtn } }, [_c('span', { staticClass: "text-primary glyphicon glyphicon-plus" }), _vm._v(" 添加\n        ")]), _vm._v(" "), _c('button', { staticClass: "btn btn-default btn-sm", on: { "click": _vm.dtlBtn } }, [_c('span', { staticClass: "text-info glyphicon glyphicon-list-alt" }), _vm._v(" 查看\n        ")]), _vm._v(" "), _c('button', { staticClass: "btn btn-default btn-sm", on: { "click": _vm.editBtn } }, [_c('span', { staticClass: "glyphicon glyphicon-edit text-warning" }), _vm._v(" 修改\n        ")]), _vm._v(" "), _c('button', { staticClass: "btn btn-default btn-sm", on: { "click": function click($event) {
          $event.preventDefault();_vm.delBtn();
        } } }, [_c('span', { staticClass: "glyphicon glyphicon-trash text-danger" }), _vm._v(" 删除\n        ")])])]), _vm._v(" "), _c('vue-list', { attrs: { "url": _vm.httpUlr.list }, scopedSlots: _vm._u([{ key: "default", fn: function fn(scope) {
          return [_c('table', { staticClass: "table table-hover table-bordered" }, [_c('thead', [_c('tr', { staticClass: "text-center" }, [_c('th', [_c('vue-checkbox', { attrs: { "callback": scope.allChcek }, model: { value: scope.allcheckBtn.ck, callback: function callback($$v) {
                _vm.$set(scope.allcheckBtn, "ck", $$v);
              }, expression: "scope.allcheckBtn.ck" } })], 1), _vm._v(" "), _c('th', [_vm._v("编号")]), _vm._v(" "), _c('th', [_vm._v("用户类型")]), _vm._v(" "), _c('th', [_vm._v("标识")]), _vm._v(" "), _c('th', [_vm._v("创建时间")]), _vm._v(" "), _c('th', [_vm._v("排序")])])]), _vm._v(" "), _c('tbody', _vm._l(scope.list, function (item) {
            return _c('tr', { key: item._id }, [_c('td', [_c('vue-checkbox', { model: { value: item.bl, callback: function callback($$v) {
                  _vm.$set(item, "bl", $$v);
                }, expression: "item.bl" } })], 1), _vm._v(" "), _c('td', [_vm._v(_vm._s(item._id))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(item.name))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(item.code))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(_vm._f("date")(item.createDate)))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(item.order))])]);
          }), 0)])];
        } }]), model: { value: _vm.list, callback: function callback($$v) {
          _vm.list = $$v;
        }, expression: "list" } })], 1), _vm._v(" "), _c('div', { staticClass: "tab-slide", class: { 'active': _vm.tab.dtl } }, [_c('vue-dtl', { attrs: { "cancel": _vm.dtlCancel, "url": _vm.httpUlr.dtl }, scopedSlots: _vm._u([{ key: "default", fn: function fn(scope) {
        ...
        } } }), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('edit.name:required'), expression: "errors.has('edit.name:required')" }], staticClass: "text-danger" }, [_vm._v("名称不为空！")])]), _vm._v(" "), _c('div', { staticClass: "form-group", class: { ' has-error': _vm.errors.has('edit.order') } }, [_c('label', { staticClass: "control-label", attrs: { "for": "name" } }, [_vm._v("排序")]), _vm._v(" "), _c('input', { directives: [{ name: "model", rawName: "v-model", value: _vm.editObj.order, expression: "editObj.order" }, { name: "validate", rawName: "v-validate", value: { required: true, min_value: 1 }, expression: "{required:true,min_value:1}" }], staticClass: "form-control", attrs: { "type": "text", "name": "order", "id": "name" }, domProps: { "value": _vm.editObj.order }, on: { "input": function input($event) {
          if ($event.target.composing) {
            return;
          }_vm.$set(_vm.editObj, "order", $event.target.value);
        } } }), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('edit.order:required'), expression: "errors.has('edit.order:required')" }], staticClass: "text-danger" }, [_vm._v("排序不为空！")]), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('edit.order:min_value'), expression: "errors.has('edit.order:min_value')" }], staticClass: "text-danger" }, [_vm._v("最小值不能为小于1！")])]), _vm._v(" "), _c('div', { staticClass: "form-group" }, [_c('button', { staticClass: "btn btn-primary", attrs: { "type": "submit", "disabled": _vm.editError } }, [_vm._v("保存")])])])]], 2)], 1), _vm._v(" "), _c('div', { staticClass: "tab-slide", class: { 'active': _vm.tab.add } }, [_c('vue-add', { attrs: { "cancel": _vm.addCancel, "url": _vm.httpUlr.add } }, [_c('template', { slot: "title" }, [_vm._v("添加用户类型")]), _vm._v(" "), [_c('form', { attrs: { "data-vv-scope": "add" }, on: { "submit": function submit($event) {
          $event.preventDefault();_vm.add('add');
        } } }, [_c('div', { staticClass: "form-group has-feedback", class: { ' has-error': _vm.errors.has('add.name') } }, [_c('label', { staticClass: "control-label", attrs: { "for": "add.name" } }, [_vm._v("名称:")]), _vm._v(" "), _c('input', { directives: [{ name: "validate", rawName: "v-validate", value: { required: true, min: 2 }, expression: "{required:true,min:2}" }, { name: "model", rawName: "v-model", value: _vm.addObj.name, expression: "addObj.name" }], staticClass: "form-control", attrs: { "type": "text", "name": "add.name", "id": "add.name", "placeholder": "输入用户名" }, domProps: { "value": _vm.addObj.name }, on: { "input": function input($event) {
          if ($event.target.composing) {
            return;
          }_vm.$set(_vm.addObj, "name", $event.target.value);
        } } }), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.name:required'), expression: "errors.has('add.name:required')" }], staticClass: "text-danger" }, [_vm._v("用户名不为空！")]), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.name:min'), expression: "errors.has('add.name:min')" }], staticClass: "text-danger" }, [_vm._v("用户名最小长度为2位！")])]), _vm._v(" "), _c('div', { staticClass: "form-group has-feedback", class: { ' has-error': _vm.errors.has('add.code') } }, [_c('label', { staticClass: "control-label", attrs: { "for": "add.code" } }, [_vm._v("标识:")]), _vm._v(" "), _c('input', { directives: [{ name: "validate", rawName: "v-validate", value: { required: true, min_value: 0, unique: 'admin/userrole/data-unique' }, expression: "{required:true,min_value:0,unique:'admin/userrole/data-unique'}" }, { name: "model", rawName: "v-model", value: _vm.addObj.code, expression: "addObj.code" }], staticClass: "form-control", attrs: { "type": "text", "name": "add.code", "id": "add.code", "placeholder": "输入数值" }, domProps: { "value": _vm.addObj.code }, on: { "input": function input($event) {
          if ($event.target.composing) {
            return;
          }_vm.$set(_vm.addObj, "code", $event.target.value);
        } } }), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.code:required'), expression: "errors.has('add.code:required')" }], staticClass: "text-danger" }, [_vm._v("标识不为空！")]), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.code:min_value'), expression: "errors.has('add.code:min_value')" }], staticClass: "text-danger" }, [_vm._v("标识最小值0！")]), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.code:unique'), expression: "errors.has('add.code:unique')" }], staticClass: "text-danger" }, [_vm._v("标识值已存在！")])]), _vm._v(" "), _c('div', { staticClass: "form-group has-feedback", class: { ' has-error': _vm.errors.has('add.order') } }, [_c('label', { staticClass: "control-label", attrs: { "for": "add.order" } }, [_vm._v("排序:")]), _vm._v(" "), _c('input', { directives: [{ name: "validate", rawName: "v-validate", value: { required: true, min_value: 1 }, expression: "{required:true,min_value:1}" }, { name: "model", rawName: "v-model", value: _vm.addObj.order, expression: "addObj.order" }], staticClass: "form-control", attrs: { "type": "text", "name": "add.order", "id": "add.order", "placeholder": "输入数值" }, domProps: { "value": _vm.addObj.order }, on: { "input": function input($event) {
          if ($event.target.composing) {
            return;
          }_vm.$set(_vm.addObj, "order", $event.target.value);
        } } }), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.order:required'), expression: "errors.has('add.order:required')" }], staticClass: "text-danger" }, [_vm._v("排序不为空！")]), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.order:min_value'), expression: "errors.has('add.order:min_value')" }], staticClass: "text-danger" }, [_vm._v("排序值不能小于1！")])]), _vm._v(" "), _c('div', { staticClass: "form-group" }, [_c('button', { staticClass: "btn btn-primary", attrs: { "type": "submit", "disabled": _vm.addError } }, [_vm._v("添加")])])])]], 2)], 1)]);
  },
  staticRenderFns: [],
  mixins: [mixin$1],
  data: function data() {
...
var App$4 = {
  render: function render() {
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('div', { staticClass: "template-share rotation" }, [_c('div', { staticClass: "tab-slide", class: { 'active': _vm.tab.index } }, [_c('div', { staticClass: "btn-toolbar clearfix" }, [_c('div', { staticClass: "btn-group pull-left" }), _vm._v(" "), _c('div', { staticClass: "btn-group pull-right" }, [_c('button', { staticClass: "btn btn-default btn-sm", on: { "click": _vm.addBtn } }, [_c('span', { staticClass: "text-primary glyphicon glyphicon-plus" }), _vm._v(" 添加\n        ")]), _vm._v(" "), _c('button', { staticClass: "btn btn-default btn-sm", on: { "click": _vm.dtlBtn } }, [_c('span', { staticClass: "text-info glyphicon glyphicon-list-alt" }), _vm._v(" 查看\n        ")]), _vm._v(" "), _c('button', { staticClass: "btn btn-default btn-sm", on: { "click": _vm.editBtn } }, [_c('span', { staticClass: "glyphicon glyphicon-edit text-warning" }), _vm._v(" 修改\n        ")]), _vm._v(" "), _c('button', { staticClass: "btn btn-default btn-sm", on: { "click": function click($event) {
          ...
          return [_c('table', { staticClass: "table table-hover table-bordered" }, [_c('thead', [_c('tr', { staticClass: "text-center" }, [_c('th', [_c('vue-checkbox', { attrs: { "callback": scope.allChcek }, model: { value: scope.allcheckBtn.ck, callback: function callback($$v) {
                _vm.$set(scope.allcheckBtn, "ck", $$v);
              }, expression: "scope.allcheckBtn.ck" } })], 1), _vm._v(" "), _c('th', [_vm._v("编号")]), _vm._v(" "), _c('th', [_vm._v("名称")]), _vm._v(" "), _c('th', [_vm._v("标识")]), _vm._v(" "), _c('th', [_vm._v("图片")]), _vm._v(" "), _c('th', [_vm._v("创建时间")])])]), _vm._v(" "), _c('tbody', _vm._l(scope.list, function (item, index) {
            return _c('tr', { key: index }, [_c('td', [_c('vue-checkbox', { model: { value: item.bl, callback: function callback($$v) {
                  _vm.$set(item, "bl", $$v);
                }, expression: "item.bl" } })], 1), _vm._v(" "), _c('td', [_vm._v(_vm._s(item._id))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(item.name))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(item.code))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(item.imgs.length > 0 ? item.imgs.length + "张图片" : "没有图片"))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(_vm._f("date")(item.createdt)))])]);
          }), 0)])];
        } }]), model: { value: _vm.list, callback: function callback($$v) {
          _vm.list = $$v;
        }, expression: "list" } })], 1), _vm._v(" "), _c('div', { staticClass: "tab-slide", class: { 'active': _vm.tab.dtl } }, [_c('vue-dtl', { attrs: { "cancel": _vm.dtlCancel, "url": _vm.httpUlr.dtl }, scopedSlots: _vm._u([{ key: "default", fn: function fn(scope) {
          return _vm._l(scope.list, function (item, index) {
            return _c('div', { key: index, staticClass: "list-group" }, [_c('div', { staticClass: "list-group-item clearfix" }, [_c('div', { staticClass: "col-xs-6 list-group-item-text" }, [_c('label', { attrs: { "for": "" } }, [_vm._v("Id:")]), _vm._v(" "), _c('span', [_vm._v(_vm._s(item._id))])]), _vm._v(" "), _c('div', { staticClass: "col-xs-6 list-group-item-text" }, [_c('label', { attrs: { "for": "" } }, [_vm._v("名称:")]), _vm._v(" "), _c('span', [_vm._v(_vm._s(item.name))])])]), _vm._v(" "), _c('div', { staticClass: "list-group-item clearfix" }, [_c('div', { staticClass: "col-xs-6 list-group-item-text" }, [_c('label', { attrs: { "for": "" } }, [_vm._v("标识:")]), _vm._v(" "), _c('span', [_vm._v(_vm._s(item.code))])]), _vm._v(" "), _c('div', { staticClass: "col-xs-6 list-group-item-text" }, [_c('label', { attrs: { "for": "" } }, [_vm._v("排序:")]), _vm._v(" "), _c('span', [_vm._v(_vm._s(item.order))])])]), _vm._v(" "), _c('div', { staticClass: "list-group-item clearfix" }, _vm._l(item.imgs, function (item2, index2) {
              return _c('div', { key: index2, staticClass: "col-xs-3", staticStyle: { "margin-bottom": "10px" } }, [_c('div', { staticClass: "img-thumbnail" }, [_c('img', { staticClass: " img-rounded", attrs: { "src": item2.src, "alt": "" } }), _vm._v(" "), _c('div', { staticClass: "caption" }, [_c('h5', [_vm._v("url:" + _vm._s(item2.url))])])])]);
            }), 0)]);
          });
        } }]) }, [_c('template', { slot: "title" }, [_vm._v("查看详细轮播图信息")])], 2)], 1), _vm._v(" "), _c('div', { staticClass: "tab-slide", class: { 'active': _vm.tab.add } }, [_c('vue-add', { attrs: { "cancel": _vm.addCancel, "url": _vm.httpUlr.add } }, [_c('template', { slot: "title" }, [_vm._v("添加轮播图")]), _vm._v(" "), [_c('form', { attrs: { "data-vv-scope": "add" }, on: { "submit": function submit($event) {
          $event.preventDefault();_vm.add('add');
        } } }, [_c('div', { staticClass: "form-group has-feedback", class: { ' has-error': _vm.errors.has('add.name') } }, [_c('label', { staticClass: "control-label", attrs: { "for": "add.name" } }, [_vm._v("名称:")]), _vm._v(" "), _c('input', { directives: [{ name: "validate", rawName: "v-validate", value: { required: true, min: 4 }, expression: "{required:true,min:4}" }, { name: "model", rawName: "v-model", value: _vm.addObj.name, expression: "addObj.name" }], staticClass: "form-control", attrs: { "type": "text", "name": "add.name", "id": "add.name", "placeholder": "输入名称" }, domProps: { "value": _vm.addObj.name }, on: { "input": function input($event) {
          if ($event.target.composing) {
            return;
          }_vm.$set(_vm.addObj, "name", $event.target.value);
        } } }), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.name:required'), expression: "errors.has('add.name:required')" }], staticClass: "text-danger" }, [_vm._v("用户名不为空！")]), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.name:min'), expression: "errors.has('add.name:min')" }], staticClass: "text-danger" }, [_vm._v("用户名最小长度为4位！")])]), _vm._v(" "), _c('div', { staticClass: "form-group has-feedback", class: { ' has-error': _vm.errors.has('add.code') } }, [_c('label', { staticClass: "control-label", attrs: { "for": "add.code" } }, [_vm._v("标识:")]), _vm._v(" "), _c('input', { directives: [{ name: "validate", rawName: "v-validate", value: { required: true, unique: 'admin/rotation/data-unique' }, expression: "{required:true,unique:'admin/rotation/data-unique'}" }, { name: "model", rawName: "v-model", value: _vm.addObj.code, expression: "addObj.code" }], staticClass: "form-control", attrs: { "type": "text", "name": "add.code", "id": "add.code", "placeholder": "输入唯一标识" }, domProps: { "value": _vm.addObj.code }, on: { "input": function input($event) {
          if ($event.target.composing) {
            return;
          }_vm.$set(_vm.addObj, "code", $event.target.value);
        } } }), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.code:required'), expression: "errors.has('add.code:required')" }], staticClass: "text-danger" }, [_vm._v("标识不为空！")]), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.code:unique'), expression: "errors.has('add.code:unique')" }], staticClass: "text-danger" }, [_vm._v("标识值已存在！")])]), _vm._v(" "), _c('div', { staticClass: "form-group has-feedback", class: { ' has-error': _vm.errors.has('add.order') } }, [_c('label', { staticClass: "control-label", attrs: { "for": "add.order" } }, [_vm._v("排序:")]), _vm._v(" "), _c('input', { directives: [{ name: "validate", rawName: "v-validate", value: { required: true, min_value: 1 }, expression: "{required:true,min_value:1}" }, { name: "model", rawName: "v-model", value: _vm.addObj.order, expression: "addObj.order" }], staticClass: "form-control", attrs: { "type": "text", "name": "add.order", "id": "add.order", "placeholder": "输入数值" }, domProps: { "value": _vm.addObj.order }, on: { "input": function input($event) {
        ...
        } } }), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.order:required'), expression: "errors.has('add.order:required')" }], staticClass: "text-danger" }, [_vm._v("排序不为空！")]), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.order:min_value'), expression: "errors.has('add.order:min_value')" }], staticClass: "text-danger" }, [_vm._v("排序值不能小于1！")])]), _vm._v(" "), _c('div', { staticClass: "form-group clearfix" }, [_c('div', { staticClass: "col-xs-12 padding-lr-no" }, [_c('label', { staticClass: "control-label", attrs: { "for": "add.code" } }, [_vm._v("上传图片:")])]), _vm._v(" "), _c('div', { staticClass: "col-sm-6 padding-lr-no" }, [_c('input', { directives: [{ name: "model", rawName: "v-model", value: _vm.addFileUpload, expression: "addFileUpload" }], staticClass: "form-control", attrs: { "type": "text", "disabled": "", "name": "", "id": "", "placeholder": "上传图片" }, domProps: { "value": _vm.addFileUpload }, on: { "input": function input($event) {
          if ($event.target.composing) {
            return;
          }_vm.addFileUpload = $event.target.value;
        } } })]), _vm._v(" "), _c('div', { staticClass: "col-sm-4" }, [_c('vue-file', { attrs: { "name": "vue-file-add", "btn-class": "btn-primary", "url": "/file", "ok": _vm.addFileOk, "file-type": "image/*", "size": 300, "timeout": 30, "line-class": "text-primary", "btn-text": "上传图片" } })], 1)]), _vm._v(" "), _c('div', { staticClass: "form-group clearfix" }, [_c('div', { staticClass: "col-xs-6 clearfix" }, _vm._l(_vm.addObj.imgs, function (item, index) {
      return _c('div', { key: index, staticClass: "upload-img clearfix" }, [_c('span', { staticClass: "close", on: { "click": function click($event) {
            _vm.addFileDel(index);
          } } }, [_vm._v("×")]), _vm._v(" "), _c('img', { attrs: { "src": item.src, "alt": "" } }), _vm._v(" "), _c('input', { directives: [{ name: "model", rawName: "v-model", value: item.url, expression: "item.url" }], staticClass: "form-control", attrs: { "placeholder": "输入url链接", "type": "text", "name": "", "id": "" }, domProps: { "value": item.url }, on: { "input": function input($event) {
            if ($event.target.composing) {
              return;
            }_vm.$set(item, "url", $event.target.value);
          } } })]);
    }), 0)]), _vm._v(" "), _c('div', { staticClass: "form-group" }, [_c('button', { staticClass: "btn btn-primary", attrs: { "type": "submit", "disabled": _vm.addError } }, [_vm._v("添加")])])])]], 2)], 1), _vm._v(" "), _c('div', { staticClass: "tab-slide", class: { 'active': _vm.tab.edit } }, [_c('vue-edit', { attrs: { "cancel": _vm.editCancel, "url": _vm.httpUlr.edit } }, [_c('template', { slot: "title" }, [_vm._v("修改轮播图信息")]), _vm._v(" "), [_c('form', { attrs: { "data-vv-scope": "edit" }, on: { "submit": function submit($event) {
          $event.preventDefault();_vm.edit('edit');
        } } }, [_c('div', { staticClass: "form-group has-feedback", class: { ' has-error': _vm.errors.has('edit.name') } }, [_c('label', { staticClass: "control-label", attrs: { "for": "edit.name" } }, [_vm._v("名称:")]), _vm._v(" "), _c('input', { directives: [{ name: "validate", rawName: "v-validate", value: { required: true, min: 4 }, expression: "{required:true,min:4}" }, { name: "model", rawName: "v-model", value: _vm.editObj.name, expression: "editObj.name" }], staticClass: "form-control", attrs: { "type": "text", "name": "edit.name", "id": "edit.name", "placeholder": "输入名称" }, domProps: { "value": _vm.editObj.name }, on: { "input": function input($event) {
          if ($event.target.composing) {
            return;
          }_vm.$set(_vm.editObj, "name", $event.target.value);
        } } }), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('edit.name:required'), expression: "errors.has('edit.name:required')" }], staticClass: "text-danger" }, [_vm._v("用户名不为空！")]), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('edit.name:min'), expression: "errors.has('edit.name:min')" }], staticClass: "text-danger" }, [_vm._v("用户名最小长度为4位！")])]), _vm._v(" "), _c('div', { staticClass: "form-group has-feedback", class: { ' has-error': _vm.errors.has('edit.order') } }, [_c('label', { staticClass: "control-label", attrs: { "for": "edit.order" } }, [_vm._v("排序:")]), _vm._v(" "), _c('input', { directives: [{ name: "validate", rawName: "v-validate", value: { required: true, min_value: 1 }, expression: "{required:true,min_value:1}" }, { name: "model", rawName: "v-model", value: _vm.editObj.order, expression: "editObj.order" }], staticClass: "form-control", attrs: { "type": "text", "name": "edit.order", "id": "edit.order", "placeholder": "输入数值" }, domProps: { "value": _vm.editObj.order }, on: { "input": function input($event) {
          if ($event.target.composing) {
            return;
          }_vm.$set(_vm.editObj, "order", $event.target.value);
        } } }), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('edit.order:required'), expression: "errors.has('edit.order:required')" }], staticClass: "text-danger" }, [_vm._v("排序不为空！")]), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('edit.order:min_value'), expression: "errors.has('edit.order:min_value')" }], staticClass: "text-danger" }, [_vm._v("排序值不能小于1！")])]), _vm._v(" "), _c('div', { staticClass: "form-group clearfix" }, [_c('div', { staticClass: "col-xs-12 padding-lr-no" }, [_c('label', { staticClass: "control-label", attrs: { "for": "edit.code" } }, [_vm._v("上传图片:")])]), _vm._v(" "), _c('div', { staticClass: "col-sm-6 padding-lr-no" }, [_c('input', { directives: [{ name: "model", rawName: "v-model", value: _vm.editdFileUpload, expression: "editdFileUpload" }], staticClass: "form-control", attrs: { "type": "text", "disabled": "", "name": "", "id": "", "placeholder": "上传图片" }, domProps: { "value": _vm.editdFileUpload }, on: { "input": function input($event) {
          if ($event.target.composing) {
            return;
          }_vm.editdFileUpload = $event.target.value;
        } } })]), _vm._v(" "), _c('div', { staticClass: "col-sm-4" }, [_c('vue-file', { attrs: { "name": "vue-file-edit", "btn-class": "btn-primary", "url": "/file", "ok": _vm.editFileOk, "file-type": "image/*", "size": 300, "timeout": 30, "line-class": "text-primary", "btn-text": "上传图片" } })], 1)]), _vm._v(" "), _c('div', { staticClass: "form-group clearfix" }, [_c('div', { staticClass: "col-xs-6 clearfix" }, _vm._l(_vm.editObj.imgs, function (item, index) {
      return _c('div', { key: index, staticClass: "upload-img clearfix" }, [_c('span', { staticClass: "close", on: { "click": function click($event) {
            _vm.editFileDel(index);
          } } }, [_vm._v("×")]), _vm._v(" "), _c('img', { attrs: { "src": item.src, "alt": "" } }), _vm._v(" "), _c('input', { directives: [{ name: "model", rawName: "v-model", value: item.url, expression: "item.url" }], staticClass: "form-control", attrs: { "placeholder": "输入url链接", "type": "text", "name": "", "id": "" }, domProps: { "value": item.url }, on: { "input": function input($event) {
            if ($event.target.composing) {
              return;
            }_vm.$set(item, "url", $event.target.value);
          } } })]);
    }), 0)]), _vm._v(" "), _c('div', { staticClass: "form-group" }, [_c('button', { staticClass: "btn btn-primary", attrs: { "type": "submit", "disabled": _vm.editError } }, [_vm._v("保存")])])])]], 2)], 1)]);
  },
  staticRenderFns: [],
  mixins: [mixin$1],
  data: function data() {
...
var App$5 = {
  render: function render() {
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('div', { staticClass: "template-share rotation" }, [_c('div', { staticClass: "tab-slide", class: { 'active': _vm.tab.index } }, [_c('div', { staticClass: "btn-toolbar clearfix" }, [_c('div', { staticClass: "btn-group pull-left" }), _vm._v(" "), _c('div', { staticClass: "btn-group pull-right" }, [_c('button', { staticClass: "btn btn-default btn-sm", on: { "click": _vm.addBtn } }, [_c('span', { staticClass: "text-primary glyphicon glyphicon-plus" }), _vm._v(" 添加\n        ")]), _vm._v(" "), _c('button', { staticClass: "btn btn-default btn-sm", on: { "click": _vm.dtlBtn } }, [_c('span', { staticClass: "text-info glyphicon glyphicon-list-alt" }), _vm._v(" 查看\n        ")]), _vm._v(" "), _c('button', { staticClass: "btn btn-default btn-sm", on: { "click": _vm.editBtn } }, [_c('span', { staticClass: "glyphicon glyphicon-edit text-warning" }), _vm._v(" 修改\n        ")]), _vm._v(" "), _c('button', { staticClass: "btn btn-default btn-sm", on: { "click": function click($event) {
        ...
        } }]) }, [_c('template', { slot: "title" }, [_vm._v("查看页面Banner大图")])], 2)], 1), _vm._v(" "), _c('div', { staticClass: "tab-slide", class: { 'active': _vm.tab.add } }, [_c('vue-add', { attrs: { "cancel": _vm.addCancel, "url": _vm.httpUlr.add } }, [_c('template', { slot: "title" }, [_vm._v("添加页面Banner大图")]), _vm._v(" "), [_c('form', { attrs: { "data-vv-scope": "add" }, on: { "submit": function submit($event) {
          $event.preventDefault();_vm.add('add');
        } } }, [_c('div', { staticClass: "form-group has-feedback", class: { ' has-error': _vm.errors.has('add.name') } }, [_c('label', { staticClass: "control-label", attrs: { "for": "add.name" } }, [_vm._v("名称:")]), _vm._v(" "), _c('input', { directives: [{ name: "validate", rawName: "v-validate", value: { required: true, min: 4 }, expression: "{required:true,min:4}" }, { name: "model", rawName: "v-model", value: _vm.addObj.name, expression: "addObj.name" }], staticClass: "form-control", attrs: { "type": "text", "name": "add.name", "id": "add.name", "placeholder": "输入名称" }, domProps: { "value": _vm.addObj.name }, on: { "input": function input($event) {
          if ($event.target.composing) {
            return;
          }_vm.$set(_vm.addObj, "name", $event.target.value);
        } } }), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.name:required'), expression: "errors.has('add.name:required')" }], staticClass: "text-danger" }, [_vm._v("用户名不为空！")]), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.name:min'), expression: "errors.has('add.name:min')" }], staticClass: "text-danger" }, [_vm._v("用户名最小长度为4位！")])]), _vm._v(" "), _c('div', { staticClass: "form-group has-feedback", class: { ' has-error': _vm.errors.has('add.code') } }, [_c('label', { staticClass: "control-label", attrs: { "for": "add.code" } }, [_vm._v("标识:")]), _vm._v(" "), _c('input', { directives: [{ name: "validate", rawName: "v-validate", value: { required: true, unique: 'admin/banner/data-unique' }, expression: "{required:true,unique:'admin/banner/data-unique'}" }, { name: "model", rawName: "v-model", value: _vm.addObj.code, expression: "addObj.code" }], staticClass: "form-control", attrs: { "type": "text", "name": "add.code", "id": "add.code", "placeholder": "输入唯一标识" }, domProps: { "value": _vm.addObj.code }, on: { "input": function input($event) {
          if ($event.target.composing) {
            return;
          }_vm.$set(_vm.addObj, "code", $event.target.value);
        } } }), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.code:required'), expression: "errors.has('add.code:required')" }], staticClass: "text-danger" }, [_vm._v("code不为空！")]), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.code:unique'), expression: "errors.has('add.code:unique')" }], staticClass: "text-danger" }, [_vm._v("code值已存在！")])]), _vm._v(" "), _c('div', { staticClass: "form-group has-feedback", class: { ' has-error': _vm.errors.has('add.order') } }, [_c('label', { staticClass: "control-label", attrs: { "for": "add.order" } }, [_vm._v("排序:")]), _vm._v(" "), _c('input', { directives: [{ name: "validate", rawName: "v-validate", value: { required: true, min_value: 1 }, expression: "{required:true,min_value:1}" }, { name: "model", rawName: "v-model", value: _vm.addObj.order, expression: "addObj.order" }], staticClass: "form-control", attrs: { "type": "text", "name": "add.order", "id": "add.order", "placeholder": "输入数值" }, domProps: { "value": _vm.addObj.order }, on: { "input": function input($event) {
          if ($event.target.composing) {
            return;
          }_vm.$set(_vm.addObj, "order", $event.target.value);
        } } }), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.order:required'), expression: "errors.has('add.order:required')" }], staticClass: "text-danger" }, [_vm._v("排序不为空！")]), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.order:min_value'), expression: "errors.has('add.order:min_value')" }], staticClass: "text-danger" }, [_vm._v("排序值不能小于1！")])]), _vm._v(" "), _c('div', { staticClass: "form-group clearfix" }, [_c('div', { staticClass: "col-xs-12 padding-lr-no" }, [_c('label', { staticClass: "control-label", attrs: { "for": "add.code" } }, [_vm._v("上传图片:")])]), _vm._v(" "), _c('div', { staticClass: "col-sm-6 padding-lr-no" }, [_c('input', { directives: [{ name: "model", rawName: "v-model", value: _vm.addFileUpload, expression: "addFileUpload" }], staticClass: "form-control", attrs: { "type": "text", "disabled": "", "name": "", "id": "", "placeholder": "上传图片" }, domProps: { "value": _vm.addFileUpload }, on: { "input": function input($event) {
    ...
    }), 0)]), _vm._v(" "), _c('div', { staticClass: "form-group" }, [_c('button', { staticClass: "btn btn-primary", attrs: { "type": "submit", "disabled": _vm.addError } }, [_vm._v("添加")])])])]], 2)], 1), _vm._v(" "), _c('div', { staticClass: "tab-slide", class: { 'active': _vm.tab.edit } }, [_c('vue-edit', { attrs: { "cancel": _vm.editCancel, "url": _vm.httpUlr.edit } }, [_c('template', { slot: "title" }, [_vm._v("修改页面Banner大图")]), _vm._v(" "), [_c('form', { attrs: { "data-vv-scope": "edit" }, on: { "submit": function submit($event) {
          $event.preventDefault();_vm.edit('edit');
        } } }, [_c('div', { staticClass: "form-group has-feedback", class: { ' has-error': _vm.errors.has('edit.name') } }, [_c('label', { staticClass: "control-label", attrs: { "for": "edit.name" } }, [_vm._v("名称:")]), _vm._v(" "), _c('input', { directives: [{ name: "validate", rawName: "v-validate", value: { required: true, min: 4 }, expression: "{required:true,min:4}" }, { name: "model", rawName: "v-model", value: _vm.editObj.name, expression: "editObj.name" }], staticClass: "form-control", attrs: { "type": "text", "name": "edit.name", "id": "edit.name", "placeholder": "输入名称" }, domProps: { "value": _vm.editObj.name }, on: { "input": function input($event) {
          if ($event.target.composing) {
            return;
...
var App$6 = {
  render: function render() {
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('div', { staticClass: "template-share userrole" }, [_c('div', { staticClass: "tab-slide", class: { 'active': _vm.tab.index } }, [_c('div', { staticClass: "btn-toolbar clearfix" }, [_c('div', { staticClass: "btn-group pull-left" }), _vm._v(" "), _c('div', { staticClass: "btn-group pull-right" }, [_c('button', { staticClass: "btn btn-default btn-sm", on: { "click": _vm.addBtn } }, [_c('span', { staticClass: "text-primary glyphicon glyphicon-plus" }), _vm._v(" 添加\n        ")]), _vm._v(" "), _c('button', { staticClass: "btn btn-default btn-sm", on: { "click": _vm.dtlBtn } }, [_c('span', { staticClass: "text-info glyphicon glyphicon-list-alt" }), _vm._v(" 查看\n        ")]), _vm._v(" "), _c('button', { staticClass: "btn btn-default btn-sm", on: { "click": _vm.editBtn } }, [_c('span', { staticClass: "glyphicon glyphicon-edit text-warning" }), _vm._v(" 修改\n        ")]), _vm._v(" "), _c('button', { staticClass: "btn btn-default btn-sm", on: { "click": function click($event) {
          ...
          return [_c('table', { staticClass: "table table-hover table-bordered" }, [_c('thead', [_c('tr', { staticClass: "text-center" }, [_c('th', [_c('vue-checkbox', { attrs: { "callback": scope.allChcek }, model: { value: scope.allcheckBtn.ck, callback: function callback($$v) {
                _vm.$set(scope.allcheckBtn, "ck", $$v);
              }, expression: "scope.allcheckBtn.ck" } })], 1), _vm._v(" "), _c('th', [_vm._v("编号")]), _vm._v(" "), _c('th', [_vm._v("系列类型名称")]), _vm._v(" "), _c('th', [_vm._v("标识")]), _vm._v(" "), _c('th', [_vm._v("创建时间")]), _vm._v(" "), _c('th', [_vm._v("排序")])])]), _vm._v(" "), _c('tbody', _vm._l(scope.list, function (item) {
            return _c('tr', { key: item._id }, [_c('td', [_c('vue-checkbox', { model: { value: item.bl, callback: function callback($$v) {
                  _vm.$set(item, "bl", $$v);
                }, expression: "item.bl" } })], 1), _vm._v(" "), _c('td', [_vm._v(_vm._s(item._id))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(item.name))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(item.code))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(_vm._f("date")(item.createdt)))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(item.order))])]);
          }), 0)])];
        } }]), model: { value: _vm.list, callback: function callback($$v) {
          _vm.list = $$v;
        }, expression: "list" } })], 1), _vm._v(" "), _c('div', { staticClass: "tab-slide", class: { 'active': _vm.tab.dtl } }, [_c('vue-dtl', { attrs: { "cancel": _vm.dtlCancel, "url": _vm.httpUlr.dtl }, scopedSlots: _vm._u([{ key: "default", fn: function fn(scope) {
        ...
        } }]) }, [_c('template', { slot: "title" }, [_vm._v("查看详细系列类型")])], 2)], 1), _vm._v(" "), _c('div', { staticClass: "tab-slide", class: { 'active': _vm.tab.edit } }, [_c('vue-edit', { attrs: { "cancel": _vm.editCancel, "url": _vm.httpUlr.edit } }, [_c('template', { slot: "title" }, [_vm._v("修改系列类型")]), _vm._v(" "), [_c('form', { attrs: { "data-vv-scope": "edit" }, on: { "submit": function submit($event) {
          $event.preventDefault();_vm.edit('edit');
        } } }, [_c('div', { staticClass: "form-group" }, [_c('label', [_vm._v("编号：" + _vm._s(_vm.editObj._id))])]), _vm._v(" "), _c('div', { staticClass: "form-group", class: { ' has-error': _vm.errors.has('edit.name') } }, [_c('label', { staticClass: "control-label", attrs: { "for": "name" } }, [_vm._v("类型名称")]), _vm._v(" "), _c('input', { directives: [{ name: "model", rawName: "v-model", value: _vm.editObj.name, expression: "editObj.name" }, { name: "validate", rawName: "v-validate", value: { required: true }, expression: "{required:true}" }], staticClass: "form-control", attrs: { "type": "text", "name": "name", "id": "name" }, domProps: { "value": _vm.editObj.name }, on: { "input": function input($event) {
          if ($event.target.composing) {
            return;
          }_vm.$set(_vm.editObj, "name", $event.target.value);
        } } }), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('edit.name:required'), expression: "errors.has('edit.name:required')" }], staticClass: "text-danger" }, [_vm._v("类型名称不为空！")])]), _vm._v(" "), _c('div', { staticClass: "form-group", class: { ' has-error': _vm.errors.has('edit.order') } }, [_c('label', { staticClass: "control-label", attrs: { "for": "name" } }, [_vm._v("排序")]), _vm._v(" "), _c('input', { directives: [{ name: "model", rawName: "v-model", value: _vm.editObj.order, expression: "editObj.order" }, { name: "validate", rawName: "v-validate", value: { required: true, min_value: 1 }, expression: "{required:true,min_value:1}" }], staticClass: "form-control", attrs: { "type": "text", "name": "order", "id": "name" }, domProps: { "value": _vm.editObj.order }, on: { "input": function input($event) {
          if ($event.target.composing) {
            return;
          }_vm.$set(_vm.editObj, "order", $event.target.value);
        } } }), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('edit.order:required'), expression: "errors.has('edit.order:required')" }], staticClass: "text-danger" }, [_vm._v("排序不为空！")]), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('edit.order:min_value'), expression: "errors.has('edit.order:min_value')" }], staticClass: "text-danger" }, [_vm._v("最小值不能为小于1！")])]), _vm._v(" "), _c('div', { staticClass: "form-group" }, [_c('button', { staticClass: "btn btn-primary", attrs: { "type": "submit", "disabled": _vm.editError } }, [_vm._v("保存")])])])]], 2)], 1), _vm._v(" "), _c('div', { staticClass: "tab-slide", class: { 'active': _vm.tab.add } }, [_c('vue-add', { attrs: { "cancel": _vm.addCancel, "url": _vm.httpUlr.add } }, [_c('template', { slot: "title" }, [_vm._v("添加系列类型")]), _vm._v(" "), [_c('form', { attrs: { "data-vv-scope": "add" }, on: { "submit": function submit($event) {
          $event.preventDefault();_vm.add('add');
        } } }, [_c('div', { staticClass: "form-group has-feedback", class: { ' has-error': _vm.errors.has('add.name') } }, [_c('label', { staticClass: "control-label", attrs: { "for": "add.name" } }, [_vm._v("名称:")]), _vm._v(" "), _c('input', { directives: [{ name: "validate", rawName: "v-validate", value: { required: true, min: 2 }, expression: "{required:true,min:2}" }, { name: "model", rawName: "v-model", value: _vm.addObj.name, expression: "addObj.name" }], staticClass: "form-control", attrs: { "type": "text", "name": "add.name", "id": "add.name", "placeholder": "输入系列类型名称" }, domProps: { "value": _vm.addObj.name }, on: { "input": function input($event) {
          if ($event.target.composing) {
            return;
          }_vm.$set(_vm.addObj, "name", $event.target.value);
        } } }), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.name:required'), expression: "errors.has('add.name:required')" }], staticClass: "text-danger" }, [_vm._v("系列类型名称不为空！")]), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.name:min'), expression: "errors.has('add.name:min')" }], staticClass: "text-danger" }, [_vm._v("系列类型名称最小长度为2位！")])]), _vm._v(" "), _c('div', { staticClass: "form-group has-feedback", class: { ' has-error': _vm.errors.has('add.code') } }, [_c('label', { staticClass: "control-label", attrs: { "for": "add.code" } }, [_vm._v("标识:")]), _vm._v(" "), _c('input', { directives: [{ name: "validate", rawName: "v-validate", value: { required: true, unique: 'admin/seriestype/data-unique' }, expression: "{required:true,unique:'admin/seriestype/data-unique'}" }, { name: "model", rawName: "v-model", value: _vm.addObj.code, expression: "addObj.code" }], staticClass: "form-control", attrs: { "type": "text", "name": "add.code", "id": "add.code", "placeholder": "输入数值" }, domProps: { "value": _vm.addObj.code }, on: { "input": function input($event) {
          if ($event.target.composing) {
            return;
          }_vm.$set(_vm.addObj, "code", $event.target.value);
        } } }), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.code:required'), expression: "errors.has('add.code:required')" }], staticClass: "text-danger" }, [_vm._v("标识不为空！")]), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.code:unique'), expression: "errors.has('add.code:unique')" }], staticClass: "text-danger" }, [_vm._v("标识值已存在！")])]), _vm._v(" "), _c('div', { staticClass: "form-group has-feedback", class: { ' has-error': _vm.errors.has('add.order') } }, [_c('label', { staticClass: "control-label", attrs: { "for": "add.order" } }, [_vm._v("排序:")]), _vm._v(" "), _c('input', { directives: [{ name: "validate", rawName: "v-validate", value: { required: true, min_value: 1 }, expression: "{required:true,min_value:1}" }, { name: "model", rawName: "v-model", value: _vm.addObj.order, expression: "addObj.order" }], staticClass: "form-control", attrs: { "type": "text", "name": "add.order", "id": "add.order", "placeholder": "输入数值" }, domProps: { "value": _vm.addObj.order }, on: { "input": function input($event) {
...
var App$7 = {
  render: function render() {
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('div', { staticClass: "template-share rotation" }, [_c('div', { staticClass: "tab-slide", class: { 'active': _vm.tab.index } }, [_c('div', { staticClass: "btn-toolbar clearfix" }, [_c('div', { staticClass: "btn-group pull-left" }), _vm._v(" "), _c('div', { staticClass: "btn-group pull-right" }, [_c('button', { staticClass: "btn btn-default btn-sm", on: { "click": _vm.addBtn } }, [_c('span', { staticClass: "text-primary glyphicon glyphicon-plus" }), _vm._v(" 添加\n        ")]), _vm._v(" "), _c('button', { staticClass: "btn btn-default btn-sm", on: { "click": _vm.dtlBtn } }, [_c('span', { staticClass: "text-info glyphicon glyphicon-list-alt" }), _vm._v(" 查看\n        ")]), _vm._v(" "), _c('button', { staticClass: "btn btn-default btn-sm", on: { "click": _vm.editBtn } }, [_c('span', { staticClass: "glyphicon glyphicon-edit text-warning" }), _vm._v(" 修改\n        ")]), _vm._v(" "), _c('button', { staticClass: "btn btn-default btn-sm", on: { "click": function click($event) {
          ...
          return [_c('table', { staticClass: "table table-hover table-bordered" }, [_c('thead', [_c('tr', { staticClass: "text-center" }, [_c('th', [_c('vue-checkbox', { attrs: { "callback": scope.allChcek }, model: { value: scope.allcheckBtn.ck, callback: function callback($$v) {
                _vm.$set(scope.allcheckBtn, "ck", $$v);
              }, expression: "scope.allcheckBtn.ck" } })], 1), _vm._v(" "), _c('th', [_vm._v("编号")]), _vm._v(" "), _c('th', [_vm._v("名称")]), _vm._v(" "), _c('th', [_vm._v("标识")]), _vm._v(" "), _c('th', [_vm._v("排序")]), _vm._v(" "), _c('th', [_vm._v("图片")]), _vm._v(" "), _c('th', [_vm._v("创建时间")])])]), _vm._v(" "), _c('tbody', _vm._l(scope.list, function (item, index) {
            return _c('tr', { key: index }, [_c('td', [_c('vue-checkbox', { model: { value: item.bl, callback: function callback($$v) {
                  _vm.$set(item, "bl", $$v);
                }, expression: "item.bl" } })], 1), _vm._v(" "), _c('td', [_vm._v(_vm._s(item._id))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(item.name))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(item.code))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(item.order))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(item.imgs.length > 0 ? item.imgs.length + "张图片" : "没有图片"))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(_vm._f("date")(item.createdt)))])]);
          }), 0)])];
        } }]), model: { value: _vm.list, callback: function callback($$v) {
          _vm.list = $$v;
        }, expression: "list" } })], 1), _vm._v(" "), _c('div', { staticClass: "tab-slide", class: { 'active': _vm.tab.dtl } }, [_c('vue-dtl', { attrs: { "cancel": _vm.dtlCancel, "url": _vm.httpUlr.dtl }, scopedSlots: _vm._u([{ key: "default", fn: function fn(scope) {
        ...
        } }]) }, [_c('template', { slot: "title" }, [_vm._v("查看页面Banner大图")])], 2)], 1), _vm._v(" "), _c('div', { staticClass: "tab-slide", class: { 'active': _vm.tab.add } }, [_c('vue-add', { attrs: { "cancel": _vm.addCancel, "url": _vm.httpUlr.add } }, [_c('template', { slot: "title" }, [_vm._v("添加产品系列")]), _vm._v(" "), [_c('form', { attrs: { "data-vv-scope": "add" }, on: { "submit": function submit($event) {
          $event.preventDefault();_vm.add('add');
        } } }, [_c('div', { staticClass: "form-group has-feedback", class: { ' has-error': _vm.errors.has('add.name') } }, [_c('label', { staticClass: "control-label", attrs: { "for": "add.name" } }, [_vm._v("系列名称:")]), _vm._v(" "), _c('input', { directives: [{ name: "validate", rawName: "v-validate", value: { required: true, min: 2 }, expression: "{required:true,min:2}" }, { name: "model", rawName: "v-model", value: _vm.addObj.name, expression: "addObj.name" }], staticClass: "form-control", attrs: { "type": "text", "name": "add.name", "id": "add.name", "placeholder": "输入名称" }, domProps: { "value": _vm.addObj.name }, on: { "input": function input($event) {
          if ($event.target.composing) {
            return;
          }_vm.$set(_vm.addObj, "name", $event.target.value);
        } } }), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.name:required'), expression: "errors.has('add.name:required')" }], staticClass: "text-danger" }, [_vm._v("系列名称不为空！")]), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.name:min'), expression: "errors.has('add.name:min')" }], staticClass: "text-danger" }, [_vm._v("系列名称最小长度为2位！")])]), _vm._v(" "), _c('div', { staticClass: "form-group", class: { ' has-error': _vm.errors.has('add.seriestypeId') } }, [_c('label', { staticClass: "control-label", attrs: { "for": "exampleInputEmail1" } }, [_vm._v("系列类型")]), _vm._v(" "), _c('select', { directives: [{ name: "validate", rawName: "v-validate", value: { required: true }, expression: "{required:true}" }, { name: "model", rawName: "v-model", value: _vm.addObj.seriestypeId, expression: "addObj.seriestypeId" }], staticClass: "form-control", attrs: { "name": "add.seriestypeId", "id": "" }, on: { "change": function change($event) {
          var $$selectedVal = Array.prototype.filter.call($event.target.options, function (o) {
            return o.selected;
          }).map(function (o) {
            var val = "_value" in o ? o._value : o.value;return val;
      ...
      return _c('option', { key: index, domProps: { "value": item._id } }, [_vm._v(_vm._s(item.name))]);
    })], 2), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.seriestypeId:required'), expression: "errors.has('add.seriestypeId:required')" }], staticClass: "text-danger" }, [_vm._v("系列类型不为空！")])]), _vm._v(" "), _c('div', { staticClass: "form-group has-feedback", class: { ' has-error': _vm.errors.has('add.code') } }, [_c('label', { staticClass: "control-label", attrs: { "for": "add.code" } }, [_vm._v("标识:")]), _vm._v(" "), _c('input', { directives: [{ name: "validate", rawName: "v-validate", value: { required: true, unique: 'admin/series/data-unique' }, expression: "{required:true,unique:'admin/series/data-unique'}" }, { name: "model", rawName: "v-model", value: _vm.addObj.code, expression: "addObj.code" }], staticClass: "form-control", attrs: { "type": "text", "name": "add.code", "id": "add.code", "placeholder": "输入唯一标识" }, domProps: { "value": _vm.addObj.code }, on: { "input": function input($event) {
          if ($event.target.composing) {
            return;
          }_vm.$set(_vm.addObj, "code", $event.target.value);
        } } }), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.code:required'), expression: "errors.has('add.code:required')" }], staticClass: "text-danger" }, [_vm._v("标识不为空！")]), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.code:unique'), expression: "errors.has('add.code:unique')" }], staticClass: "text-danger" }, [_vm._v("标识已存在！")])]), _vm._v(" "), _c('div', { staticClass: "form-group has-feedback", class: { ' has-error': _vm.errors.has('add.order') } }, [_c('label', { staticClass: "control-label", attrs: { "for": "add.order" } }, [_vm._v("排序:")]), _vm._v(" "), _c('input', { directives: [{ name: "validate", rawName: "v-validate", value: { required: true, min_value: 1 }, expression: "{required:true,min_value:1}" }, { name: "model", rawName: "v-model", value: _vm.addObj.order, expression: "addObj.order" }], staticClass: "form-control", attrs: { "type": "text", "name": "add.order", "id": "add.order", "placeholder": "输入数值" }, domProps: { "value": _vm.addObj.order }, on: { "input": function input($event) {
          if ($event.target.composing) {
            return;
          }_vm.$set(_vm.addObj, "order", $event.target.value);
        } } }), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.order:required'), expression: "errors.has('add.order:required')" }], staticClass: "text-danger" }, [_vm._v("排序不为空！")]), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.order:min_value'), expression: "errors.has('add.order:min_value')" }], staticClass: "text-danger" }, [_vm._v("排序值不能小于1！")])]), _vm._v(" "), _c('div', { staticClass: "form-group clearfix" }, [_c('div', { staticClass: "col-xs-12 padding-lr-no" }, [_c('label', { staticClass: "control-label", attrs: { "for": "add.code" } }, [_vm._v("上传图片:")])]), _vm._v(" "), _c('div', { staticClass: "col-sm-6 padding-lr-no" }, [_c('input', { directives: [{ name: "model", rawName: "v-model", value: _vm.addFileUpload, expression: "addFileUpload" }], staticClass: "form-control", attrs: { "type": "text", "disabled": "", "name": "", "id": "", "placeholder": "上传图片" }, domProps: { "value": _vm.addFileUpload }, on: { "input": function input($event) {
        ...
        } } })]), _vm._v(" "), _c('div', { staticClass: "col-sm-4" }, [_c('vue-file', { attrs: { "name": "vue-file-add", "btn-class": "btn-primary", "url": "http://localhost:3000/file", "ok": _vm.addFileOk, "file-type": "image/*", "size": 300, "timeout": 30, "line-class": "text-primary", "btn-text": "上传图片" } })], 1)]), _vm._v(" "), _c('div', { staticClass: "form-group clearfix" }, [_c('div', { staticClass: "col-xs-6 clearfix" }, _vm._l(_vm.addObj.imgs, function (item, index) {
      return _c('div', { key: index, staticClass: "upload-img clearfix" }, [_c('span', { staticClass: "close", on: { "click": function click($event) {
            _vm.addFileDel(index);
          } } }, [_vm._v("×")]), _vm._v(" "), _c('img', { attrs: { "src": item.src, "alt": "" } }), _vm._v(" "), _c('input', { directives: [{ name: "model", rawName: "v-model", value: item.url, expression: "item.url" }], staticClass: "form-control", attrs: { "placeholder": "输入url链接", "type": "text", "name": "", "id": "" }, domProps: { "value": item.url }, on: { "input": function input($event) {
            if ($event.target.composing) {
    ...
    }), 0)]), _vm._v(" "), _c('div', { staticClass: "form-group" }, [_c('button', { staticClass: "btn btn-primary", attrs: { "type": "submit", "disabled": _vm.addError } }, [_vm._v("添加")])])])]], 2)], 1), _vm._v(" "), _c('div', { staticClass: "tab-slide", class: { 'active': _vm.tab.edit } }, [_c('vue-edit', { attrs: { "cancel": _vm.editCancel, "url": _vm.httpUlr.edit } }, [_c('template', { slot: "title" }, [_vm._v("修改产品系列")]), _vm._v(" "), [_c('form', { attrs: { "data-vv-scope": "edit" }, on: { "submit": function submit($event) {
          $event.preventDefault();_vm.edit('edit');
        } } }, [_c('div', { staticClass: "form-group" }, [_c('h5', [_vm._v("标识:" + _vm._s(_vm.editObj.code))])]), _vm._v(" "), _c('div', { staticClass: "form-group has-feedback", class: { ' has-error': _vm.errors.has('edit.name') } }, [_c('label', { staticClass: "control-label", attrs: { "for": "edit.name" } }, [_vm._v("系列名称:")]), _vm._v(" "), _c('input', { directives: [{ name: "validate", rawName: "v-validate", value: { required: true, min: 2 }, expression: "{required:true,min:2}" }, { name: "model", rawName: "v-model", value: _vm.editObj.name, expression: "editObj.name" }], staticClass: "form-control", attrs: { "type": "text", "name": "edit.name", "id": "edit.name", "placeholder": "输入名称" }, domProps: { "value": _vm.editObj.name }, on: { "input": function input($event) {
          if ($event.target.composing) {
            return;
          }_vm.$set(_vm.editObj, "name", $event.target.value);
        } } }), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('edit.name:required'), expression: "errors.has('edit.name:required')" }], staticClass: "text-danger" }, [_vm._v("系列名称不为空！")]), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('edit.name:min'), expression: "errors.has('edit.name:min')" }], staticClass: "text-danger" }, [_vm._v("系列名称最小长度为2位！")])]), _vm._v(" "), _c('div', { staticClass: "form-group", class: { ' has-error': _vm.errors.has('edit.seriestypeId') } }, [_c('label', { staticClass: "control-label", attrs: { "for": "exampleInputEmail1" } }, [_vm._v("系列类型")]), _vm._v(" "), _c('select', { directives: [{ name: "validate", rawName: "v-validate", value: { required: true }, expression: "{required:true}" }, { name: "model", rawName: "v-model", value: _vm.editObj.seriestypeId, expression: "editObj.seriestypeId" }], staticClass: "form-control", attrs: { "name": "edit.seriestypeId", "id": "" }, on: { "change": function change($event) {
          var $$selectedVal = Array.prototype.filter.call($event.target.options, function (o) {
            return o.selected;
          }).map(function (o) {
            var val = "_value" in o ? o._value : o.value;return val;
      ...
      return _c('option', { key: index, domProps: { "value": item._id, "selected": item._id === _vm.editObj.seriestypeId } }, [_vm._v(_vm._s(item.name))]);
    }), 0), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('edit.seriestypeId:required'), expression: "errors.has('edit.seriestypeId:required')" }], staticClass: "text-danger" }, [_vm._v("系列类型不为空！")])]), _vm._v(" "), _c('div', { staticClass: "form-group has-feedback", class: { ' has-error': _vm.errors.has('add.order') } }, [_c('label', { staticClass: "control-label", attrs: { "for": "edit.order" } }, [_vm._v("排序:")]), _vm._v(" "), _c('input', { directives: [{ name: "validate", rawName: "v-validate", value: { required: true, min_value: 1 }, expression: "{required:true,min_value:1}" }, { name: "model", rawName: "v-model", value: _vm.editObj.order, expression: "editObj.order" }], staticClass: "form-control", attrs: { "type": "text", "name": "edit.order", "id": "edit.order", "placeholder": "输入数值" }, domProps: { "value": _vm.editObj.order }, on: { "input": function input($event) {
          if ($event.target.composing) {
            return;
          }_vm.$set(_vm.editObj, "order", $event.target.value);
        } } }), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('edit.order:required'), expression: "errors.has('edit.order:required')" }], staticClass: "text-danger" }, [_vm._v("排序不为空！")]), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('edit.order:min_value'), expression: "errors.has('edit.order:min_value')" }], staticClass: "text-danger" }, [_vm._v("排序值不能小于1！")])]), _vm._v(" "), _c('div', { staticClass: "form-group clearfix" }, [_c('div', { staticClass: "col-xs-12 padding-lr-no" }, [_c('label', { staticClass: "control-label", attrs: { "for": "edit.code" } }, [_vm._v("上传图片:")])]), _vm._v(" "), _c('div', { staticClass: "col-sm-6 padding-lr-no" }, [_c('input', { directives: [{ name: "model", rawName: "v-model", value: _vm.addFileUpload, expression: "addFileUpload" }], staticClass: "form-control", attrs: { "type": "text", "disabled": "", "name": "", "id": "", "placeholder": "上传图片" }, domProps: { "value": _vm.addFileUpload }, on: { "input": function input($event) {
...
var App$8 = {
  render: function render() {
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('div', { staticClass: "template-share rotation" }, [_c('div', { staticClass: "tab-slide", class: { 'active': _vm.tab.index } }, [_c('div', { staticClass: "btn-toolbar clearfix" }, [_c('div', { staticClass: "btn-group pull-left" }), _vm._v(" "), _c('div', { staticClass: "btn-group pull-right" }, [_c('button', { staticClass: "btn btn-default btn-sm", on: { "click": _vm.addBtn } }, [_c('span', { staticClass: "text-primary glyphicon glyphicon-plus" }), _vm._v(" 添加\n        ")]), _vm._v(" "), _c('button', { staticClass: "btn btn-default btn-sm", on: { "click": _vm.dtlBtn } }, [_c('span', { staticClass: "text-info glyphicon glyphicon-list-alt" }), _vm._v(" 查看\n        ")]), _vm._v(" "), _c('button', { staticClass: "btn btn-default btn-sm", on: { "click": _vm.editBtn } }, [_c('span', { staticClass: "glyphicon glyphicon-edit text-warning" }), _vm._v(" 修改\n        ")]), _vm._v(" "), _c('button', { staticClass: "btn btn-default btn-sm", on: { "click": function click($event) {
          ...
          return [_c('table', { staticClass: "table table-hover table-bordered" }, [_c('thead', [_c('tr', { staticClass: "text-center" }, [_c('th', [_c('vue-checkbox', { attrs: { "callback": scope.allChcek }, model: { value: scope.allcheckBtn.ck, callback: function callback($$v) {
                _vm.$set(scope.allcheckBtn, "ck", $$v);
              }, expression: "scope.allcheckBtn.ck" } })], 1), _vm._v(" "), _c('th', [_vm._v("编号")]), _vm._v(" "), _c('th', [_vm._v("公司名称")]), _vm._v(" "), _c('th', [_vm._v("标识")]), _vm._v(" "), _c('th', [_vm._v("排序")]), _vm._v(" "), _c('th', [_vm._v("X坐标")]), _vm._v(" "), _c('th', [_vm._v("Y坐标")]), _vm._v(" "), _c('th', [_vm._v("地址")]), _vm._v(" "), _c('th', [_vm._v("创建时间")])])]), _vm._v(" "), _c('tbody', _vm._l(scope.list, function (item, index) {
            return _c('tr', { key: index }, [_c('td', [_c('vue-checkbox', { model: { value: item.bl, callback: function callback($$v) {
                  _vm.$set(item, "bl", $$v);
                }, expression: "item.bl" } })], 1), _vm._v(" "), _c('td', [_vm._v(_vm._s(item._id))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(item.name))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(item.code))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(item.order))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(item.x))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(item.y))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(item.addr))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(_vm._f("date")(item.createdt)))])]);
          }), 0)])];
        } }]), model: { value: _vm.list, callback: function callback($$v) {
          _vm.list = $$v;
        }, expression: "list" } })], 1), _vm._v(" "), _c('div', { staticClass: "tab-slide", class: { 'active': _vm.tab.dtl } }, [_c('vue-dtl', { attrs: { "cancel": _vm.dtlCancel, "url": _vm.httpUlr.dtl }, scopedSlots: _vm._u([{ key: "default", fn: function fn(scope) {
        ...
        } }]) }, [_c('template', { slot: "title" }, [_vm._v("查看页面Banner大图")])], 2)], 1), _vm._v(" "), _c('div', { staticClass: "tab-slide", class: { 'active': _vm.tab.add } }, [_c('vue-add', { attrs: { "cancel": _vm.addCancel, "url": _vm.httpUlr.add } }, [_c('template', { slot: "title" }, [_vm._v("添加联系我们")]), _vm._v(" "), [_c('form', { attrs: { "data-vv-scope": "add" }, on: { "submit": function submit($event) {
          $event.preventDefault();_vm.add('add');
        } } }, [_c('div', { staticClass: "form-group has-feedback", class: { ' has-error': _vm.errors.has('add.name') } }, [_c('label', { staticClass: "control-label", attrs: { "for": "add.name" } }, [_vm._v("公司名称:")]), _vm._v(" "), _c('input', { directives: [{ name: "validate", rawName: "v-validate", value: { required: true, min: 2 }, expression: "{required:true,min:2}" }, { name: "model", rawName: "v-model", value: _vm.addObj.name, expression: "addObj.name" }], staticClass: "form-control", attrs: { "type": "text", "name": "add.name", "id": "add.name", "placeholder": "输入名称" }, domProps: { "value": _vm.addObj.name }, on: { "input": function input($event) {
          if ($event.target.composing) {
            return;
          }_vm.$set(_vm.addObj, "name", $event.target.value);
        } } }), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.name:required'), expression: "errors.has('add.name:required')" }], staticClass: "text-danger" }, [_vm._v("公司名称不为空！")]), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.name:min'), expression: "errors.has('add.name:min')" }], staticClass: "text-danger" }, [_vm._v("公司名称最小长度为2位！")])]), _vm._v(" "), _c('div', { staticClass: "form-group has-feedback", class: { ' has-error': _vm.errors.has('add.code') } }, [_c('label', { staticClass: "control-label", attrs: { "for": "add.code" } }, [_vm._v("标识:")]), _vm._v(" "), _c('input', { directives: [{ name: "validate", rawName: "v-validate", value: { required: true, unique: 'admin/contact/data-unique' }, expression: "{required:true,unique:'admin/contact/data-unique'}" }, { name: "model", rawName: "v-model", value: _vm.addObj.code, expression: "addObj.code" }], staticClass: "form-control", attrs: { "type": "text", "name": "add.code", "id": "add.code", "placeholder": "输入唯一标识" }, domProps: { "value": _vm.addObj.code }, on: { "input": function input($event) {
          if ($event.target.composing) {
            return;
          }_vm.$set(_vm.addObj, "code", $event.target.value);
        } } }), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.code:required'), expression: "errors.has('add.code:required')" }], staticClass: "text-danger" }, [_vm._v("标识不为空！")]), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.code:unique'), expression: "errors.has('add.code:unique')" }], staticClass: "text-danger" }, [_vm._v("标识已存在！")])]), _vm._v(" "), _c('div', { staticClass: "form-group has-feedback", class: { ' has-error': _vm.errors.has('add.order') } }, [_c('label', { staticClass: "control-label", attrs: { "for": "add.order" } }, [_vm._v("排序:")]), _vm._v(" "), _c('input', { directives: [{ name: "validate", rawName: "v-validate", value: { required: true, min_value: 1 }, expression: "{required:true,min_value:1}" }, { name: "model", rawName: "v-model", value: _vm.addObj.order, expression: "addObj.order" }], staticClass: "form-control", attrs: { "type": "text", "name": "add.order", "id": "add.order", "placeholder": "输入数值" }, domProps: { "value": _vm.addObj.order }, on: { "input": function input($event) {
        ...
        } } }), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.order:required'), expression: "errors.has('add.order:required')" }], staticClass: "text-danger" }, [_vm._v("排序不为空！")]), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.order:min_value'), expression: "errors.has('add.order:min_value')" }], staticClass: "text-danger" }, [_vm._v("排序值不能小于1！")])]), _vm._v(" "), _c('div', { staticClass: "form-group has-feedback", class: { ' has-error': _vm.errors.has('add.x') } }, [_c('label', { staticClass: "control-label", attrs: { "for": "add.x" } }, [_vm._v("X坐标:")]), _vm._v(" "), _c('input', { directives: [{ name: "validate", rawName: "v-validate", value: { required: true, decimal: true }, expression: "{required:true,decimal:true}" }, { name: "model", rawName: "v-model", value: _vm.addObj.x, expression: "addObj.x" }], staticClass: "form-control", attrs: { "type": "text", "name": "add.x", "id": "add.x", "placeholder": "输入数值" }, domProps: { "value": _vm.addObj.x }, on: { "input": function input($event) {
          if ($event.target.composing) {
            return;
          }_vm.$set(_vm.addObj, "x", $event.target.value);
        } } }), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.x:required'), expression: "errors.has('add.x:required')" }], staticClass: "text-danger" }, [_vm._v("X坐标不为空！")]), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.x:decimal'), expression: "errors.has('add.x:decimal')" }], staticClass: "text-danger" }, [_vm._v("不是有效的数值！")])]), _vm._v(" "), _c('div', { staticClass: "form-group has-feedback", class: { ' has-error': _vm.errors.has('add.y') } }, [_c('label', { staticClass: "control-label", attrs: { "for": "add.y" } }, [_vm._v("Y坐标:")]), _vm._v(" "), _c('input', { directives: [{ name: "validate", rawName: "v-validate", value: { required: true, decimal: true }, expression: "{required:true,decimal:true}" }, { name: "model", rawName: "v-model", value: _vm.addObj.y, expression: "addObj.y" }], staticClass: "form-control", attrs: { "type": "text", "name": "add.y", "id": "add.y", "placeholder": "输入数值" }, domProps: { "value": _vm.addObj.y }, on: { "input": function input($event) {
          if ($event.target.composing) {
            return;
          }_vm.$set(_vm.addObj, "y", $event.target.value);
        } } }), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.y:required'), expression: "errors.has('add.y:required')" }], staticClass: "text-danger" }, [_vm._v("Y坐标不为空！")]), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.y:decimal'), expression: "errors.has('add.y:decimal')" }], staticClass: "text-danger" }, [_vm._v("不是有效的数值！")])]), _vm._v(" "), _c('div', { staticClass: "form-group has-feedback", class: { ' has-error': _vm.errors.has('add.tel') } }, [_c('label', { staticClass: "control-label", attrs: { "for": "add.tel" } }, [_vm._v("联系电话:")]), _vm._v(" "), _c('input', { directives: [{ name: "validate", rawName: "v-validate", value: { required: true, regex: /^\d[0-9-]{4,}$/ }, expression: "{required:true,regex:/^\\d[0-9-]{4,}$/}" }, { name: "model", rawName: "v-model", value: _vm.addObj.tel, expression: "addObj.tel" }], staticClass: "form-control", attrs: { "type": "text", "name": "add.tel", "id": "add.tel", "placeholder": "输入数值" }, domProps: { "value": _vm.addObj.tel }, on: { "input": function input($event) {
          if ($event.target.composing) {
            return;
          }_vm.$set(_vm.addObj, "tel", $event.target.value);
        } } }), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.tel:required'), expression: "errors.has('add.tel:required')" }], staticClass: "text-danger" }, [_vm._v("联系电话不能为空！")]), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.tel:regex'), expression: "errors.has('add.tel:regex')" }], staticClass: "text-danger" }, [_vm._v("联系电话格式不对！")])]), _vm._v(" "), _c('div', { staticClass: "form-group has-feedback", class: { ' has-error': _vm.errors.has('add.addr') } }, [_c('label', { staticClass: "control-label", attrs: { "for": "add.addr" } }, [_vm._v("地址:")]), _vm._v(" "), _c('input', { directives: [{ name: "validate", rawName: "v-validate", value: { required: true }, expression: "{required:true}" }, { name: "model", rawName: "v-model", value: _vm.addObj.addr, expression: "addObj.addr" }], staticClass: "form-control", attrs: { "type": "text", "name": "add.addr", "id": "add.addr", "placeholder": "输入地址" }, domProps: { "value": _vm.addObj.addr }, on: { "input": function input($event) {
          if ($event.target.composing) {
            return;
          }_vm.$set(_vm.addObj, "addr", $event.target.value);
        } } }), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.addr:required'), expression: "errors.has('add.addr:required')" }], staticClass: "text-danger" }, [_vm._v("地址不能为空！")])]), _vm._v(" "), _c('div', { staticClass: "form-group" }, [_c('button', { staticClass: "btn btn-primary", attrs: { "type": "submit", "disabled": _vm.addError } }, [_vm._v("添加")])])])]], 2)], 1), _vm._v(" "), _c('div', { staticClass: "tab-slide", class: { 'active': _vm.tab.edit } }, [_c('vue-edit', { attrs: { "cancel": _vm.editCancel, "url": _vm.httpUlr.edit } }, [_c('template', { slot: "title" }, [_vm._v("修改联系我们")]), _vm._v(" "), [_c('form', { attrs: { "data-vv-scope": "edit" }, on: { "submit": function submit($event) {
          $event.preventDefault();_vm.edit('edit');
        } } }, [_c('div', { staticClass: " form-group" }, [_c('h5', [_vm._v("标识：" + _vm._s(_vm.editObj.code))])]), _vm._v(" "), _c('div', { staticClass: "form-group has-feedback", class: { ' has-error': _vm.errors.has('edit.name') } }, [_c('label', { staticClass: "control-label", attrs: { "for": "edit.name" } }, [_vm._v("公司名称:")]), _vm._v(" "), _c('input', { directives: [{ name: "validate", rawName: "v-validate", value: { required: true, min: 2 }, expression: "{required:true,min:2}" }, { name: "model", rawName: "v-model", value: _vm.editObj.name, expression: "editObj.name" }], staticClass: "form-control", attrs: { "type": "text", "name": "edit.name", "id": "edit.name", "placeholder": "输入名称" }, domProps: { "value": _vm.editObj.name }, on: { "input": function input($event) {
          if ($event.target.composing) {
            return;
          }_vm.$set(_vm.editObj, "name", $event.target.value);
        } } }), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('edit.name:required'), expression: "errors.has('edit.name:required')" }], staticClass: "text-danger" }, [_vm._v("公司名称不为空！")]), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('edit.name:min'), expression: "errors.has('edit.name:min')" }], staticClass: "text-danger" }, [_vm._v("公司名称最小长度为2位！")])]), _vm._v(" "), _c('div', { staticClass: "form-group has-feedback", class: { ' has-error': _vm.errors.has('edit.order') } }, [_c('label', { staticClass: "control-label", attrs: { "for": "edit.order" } }, [_vm._v("排序:")]), _vm._v(" "), _c('input', { directives: [{ name: "validate", rawName: "v-validate", value: { required: true, min_value: 1 }, expression: "{required:true,min_value:1}" }, { name: "model", rawName: "v-model", value: _vm.editObj.order, expression: "editObj.order" }], staticClass: "form-control", attrs: { "type": "text", "name": "edit.order", "id": "edit.order", "placeholder": "输入数值" }, domProps: { "value": _vm.editObj.order }, on: { "input": function input($event) {
          if ($event.target.composing) {
            return;
          }_vm.$set(_vm.editObj, "order", $event.target.value);
        } } }), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('edit.order:required'), expression: "errors.has('edit.order:required')" }], staticClass: "text-danger" }, [_vm._v("排序不为空！")]), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('edit.order:min_value'), expression: "errors.has('edit.order:min_value')" }], staticClass: "text-danger" }, [_vm._v("排序值不能小于1！")])]), _vm._v(" "), _c('div', { staticClass: "form-group has-feedback", class: { ' has-error': _vm.errors.has('edit.x') } }, [_c('label', { staticClass: "control-label", attrs: { "for": "edit.x" } }, [_vm._v("X坐标:")]), _vm._v(" "), _c('input', { directives: [{ name: "validate", rawName: "v-validate", value: { required: true, decimal: true }, expression: "{required:true,decimal:true}" }, { name: "model", rawName: "v-model", value: _vm.editObj.x, expression: "editObj.x" }], staticClass: "form-control", attrs: { "type": "text", "name": "edit.x", "id": "edit.x", "placeholder": "输入数值" }, domProps: { "value": _vm.editObj.x }, on: { "input": function input($event) {
          if ($event.target.composing) {
            return;
          }_vm.$set(_vm.editObj, "x", $event.target.value);
        } } }), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('edit.x:required'), expression: "errors.has('edit.x:required')" }], staticClass: "text-danger" }, [_vm._v("X坐标不为空！")]), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('edit.x:decimal'), expression: "errors.has('edit.x:decimal')" }], staticClass: "text-danger" }, [_vm._v("不是有效的数值！")])]), _vm._v(" "), _c('div', { staticClass: "form-group has-feedback", class: { ' has-error': _vm.errors.has('edit.y') } }, [_c('label', { staticClass: "control-label", attrs: { "for": "edit.y" } }, [_vm._v("Y坐标:")]), _vm._v(" "), _c('input', { directives: [{ name: "validate", rawName: "v-validate", value: { required: true, decimal: true }, expression: "{required:true,decimal:true}" }, { name: "model", rawName: "v-model", value: _vm.editObj.y, expression: "editObj.y" }], staticClass: "form-control", attrs: { "type": "text", "name": "edit.y", "id": "edit.y", "placeholder": "输入数值" }, domProps: { "value": _vm.editObj.y }, on: { "input": function input($event) {
          if ($event.target.composing) {
            return;
          }_vm.$set(_vm.editObj, "y", $event.target.value);
        } } }), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('edit.y:required'), expression: "errors.has('edit.y:required')" }], staticClass: "text-danger" }, [_vm._v("Y坐标不为空！")]), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('edit.y:decimal'), expression: "errors.has('edit.y:decimal')" }], staticClass: "text-danger" }, [_vm._v("不是有效的数值！")])]), _vm._v(" "), _c('div', { staticClass: "form-group has-feedback", class: { ' has-error': _vm.errors.has('edit.tel') } }, [_c('label', { staticClass: "control-label", attrs: { "for": "edit.tel" } }, [_vm._v("联系电话:")]), _vm._v(" "), _c('input', { directives: [{ name: "validate", rawName: "v-validate", value: { required: true, regex: /^\d[0-9-]{4,}$/ }, expression: "{required:true,regex:/^\\d[0-9-]{4,}$/}" }, { name: "model", rawName: "v-model", value: _vm.editObj.tel, expression: "editObj.tel" }], staticClass: "form-control", attrs: { "type": "text", "name": "edit.tel", "id": "edit.tel", "placeholder": "输入数值" }, domProps: { "value": _vm.editObj.tel }, on: { "input": function input($event) {
          if ($event.target.composing) {
            return;
          }_vm.$set(_vm.editObj, "tel", $event.target.value);
        } } }), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('edit.tel:required'), expression: "errors.has('edit.tel:required')" }], staticClass: "text-danger" }, [_vm._v("联系电话不能为空！")]), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('edit.tel:regex'), expression: "errors.has('edit.tel:regex')" }], staticClass: "text-danger" }, [_vm._v("联系电话格式不对！")])]), _vm._v(" "), _c('div', { staticClass: "form-group has-feedback", class: { ' has-error': _vm.errors.has('edit.addr') } }, [_c('label', { staticClass: "control-label", attrs: { "for": "edit.addr" } }, [_vm._v("地址:")]), _vm._v(" "), _c('input', { directives: [{ name: "validate", rawName: "v-validate", value: { required: true }, expression: "{required:true}" }, { name: "model", rawName: "v-model", value: _vm.editObj.addr, expression: "editObj.addr" }], staticClass: "form-control", attrs: { "type": "text", "name": "edit.addr", "id": "edit.addr", "placeholder": "输入地址" }, domProps: { "value": _vm.editObj.addr }, on: { "input": function input($event) {
          if ($event.target.composing) {
            return;
          }_vm.$set(_vm.editObj, "addr", $event.target.value);
        } } }), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('edit.addr:required'), expression: "errors.has('edit.addr:required')" }], staticClass: "text-danger" }, [_vm._v("地址不能为空！")])]), _vm._v(" "), _c('div', { staticClass: "form-group" }, [_c('button', { staticClass: "btn btn-primary", attrs: { "type": "submit", "disabled": _vm.editError } }, [_vm._v("保存")])])])]], 2)], 1)]);
  },
  staticRenderFns: [],
  mixins: [mixin$1],
  data: function data() {
...
var App$9 = {
  render: function render() {
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('div', { staticClass: "template-share rotation" }, [_c('div', { staticClass: "tab-slide", class: { 'active': _vm.tab.index } }, [_c('div', { staticClass: "btn-toolbar clearfix" }, [_c('div', { staticClass: "btn-group pull-left" }), _vm._v(" "), _c('div', { staticClass: "btn-group pull-right" }, [_c('button', { staticClass: "btn btn-default btn-sm", on: { "click": _vm.addBtn } }, [_c('span', { staticClass: "text-primary glyphicon glyphicon-plus" }), _vm._v(" 添加\n        ")]), _vm._v(" "), _c('button', { staticClass: "btn btn-default btn-sm", on: { "click": _vm.dtlBtn } }, [_c('span', { staticClass: "text-info glyphicon glyphicon-list-alt" }), _vm._v(" 查看\n        ")]), _vm._v(" "), _c('button', { staticClass: "btn btn-default btn-sm", on: { "click": _vm.editBtn } }, [_c('span', { staticClass: "glyphicon glyphicon-edit text-warning" }), _vm._v(" 修改\n        ")]), _vm._v(" "), _c('button', { staticClass: "btn btn-default btn-sm", on: { "click": function click($event) {
        ...
        } }]) }, [_c('template', { slot: "title" }, [_vm._v("查看详细服务网点")])], 2)], 1), _vm._v(" "), _c('div', { staticClass: "tab-slide", class: { 'active': _vm.tab.add } }, [_c('vue-add', { attrs: { "cancel": _vm.addCancel, "url": _vm.httpUlr.add } }, [_c('template', { slot: "title" }, [_vm._v("添加服务网点")]), _vm._v(" "), [_c('form', { attrs: { "data-vv-scope": "add" }, on: { "submit": function submit($event) {
          $event.preventDefault();_vm.add('add');
        } } }, [_c('div', { staticClass: "form-group has-feedback", class: { ' has-error': _vm.errors.has('add.name') } }, [_c('label', { staticClass: "control-label", attrs: { "for": "add.name" } }, [_vm._v("公司名称:")]), _vm._v(" "), _c('input', { directives: [{ name: "validate", rawName: "v-validate", value: { required: true, min: 4 }, expression: "{required:true,min:4}" }, { name: "model", rawName: "v-model", value: _vm.addObj.name, expression: "addObj.name" }], staticClass: "form-control", attrs: { "type": "text", "name": "add.name", "id": "add.name", "placeholder": "输入名称" }, domProps: { "value": _vm.addObj.name }, on: { "input": function input($event) {
          if ($event.target.composing) {
            return;
          }_vm.$set(_vm.addObj, "name", $event.target.value);
        } } }), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.name:required'), expression: "errors.has('add.name:required')" }], staticClass: "text-danger" }, [_vm._v("公司名称不能为空！")]), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.name:min'), expression: "errors.has('add.name:min')" }], staticClass: "text-danger" }, [_vm._v("公司名称最小长度为4位！")])]), _vm._v(" "), _c('div', { staticClass: "form-group has-feedback", class: { ' has-error': _vm.errors.has('add.code') } }, [_c('label', { staticClass: "control-label", attrs: { "for": "add.code" } }, [_vm._v("标识:")]), _vm._v(" "), _c('input', { directives: [{ name: "validate", rawName: "v-validate", value: { required: true, unique: 'admin/svcnet/data-unique' }, expression: "{required:true,unique:'admin/svcnet/data-unique'}" }, { name: "model", rawName: "v-model", value: _vm.addObj.code, expression: "addObj.code" }], staticClass: "form-control", attrs: { "type": "text", "name": "add.code", "id": "add.code", "placeholder": "输入标识" }, domProps: { "value": _vm.addObj.code }, on: { "input": function input($event) {
          if ($event.target.composing) {
            return;
          }_vm.$set(_vm.addObj, "code", $event.target.value);
        } } }), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.code:required'), expression: "errors.has('add.code:required')" }], staticClass: "text-danger" }, [_vm._v("code不能为空！")]), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.code:unique'), expression: "errors.has('add.code:unique')" }], staticClass: "text-danger" }, [_vm._v("code值已存在！")])]), _vm._v(" "), _c('div', { staticClass: "form-group has-feedback", class: { ' has-error': _vm.errors.has('add.order') } }, [_c('label', { staticClass: "control-label", attrs: { "for": "add.order" } }, [_vm._v("排序:")]), _vm._v(" "), _c('input', { directives: [{ name: "validate", rawName: "v-validate", value: { required: true, min_value: 1 }, expression: "{required:true,min_value:1}" }, { name: "model", rawName: "v-model", value: _vm.addObj.order, expression: "addObj.order" }], staticClass: "form-control", attrs: { "type": "text", "name": "add.order", "id": "add.order", "placeholder": "输入数值" }, domProps: { "value": _vm.addObj.order }, on: { "input": function input($event) {
          if ($event.target.composing) {
            return;
          }_vm.$set(_vm.addObj, "order", $event.target.value);
      ...
      return _c('div', { key: index, staticClass: "upload-img clearfix" }, [_c('span', { staticClass: "close", on: { "click": function click($event) {
    ...
    }), 0)]), _vm._v(" "), _c('div', { staticClass: "form-group" }, [_c('button', { staticClass: "btn btn-primary", attrs: { "type": "submit", "disabled": _vm.addError } }, [_vm._v("添加")])])])]], 2)], 1), _vm._v(" "), _c('div', { staticClass: "tab-slide", class: { 'active': _vm.tab.edit } }, [_c('vue-edit', { attrs: { "cancel": _vm.editCancel, "url": _vm.httpUlr.edit } }, [_c('template', { slot: "title" }, [_vm._v("修改服务网点")]), _vm._v(" "), [_c('form', { attrs: { "data-vv-scope": "edit" }, on: { "submit": function submit($event) {
          $event.preventDefault();_vm.edit('edit');
        } } }, [_c('div', { staticClass: "form-group" }, [_c('h5', [_vm._v("标识：" + _vm._s(_vm.editObj.code))])]), _vm._v(" "), _c('div', { staticClass: "form-group has-feedback", class: { ' has-error': _vm.errors.has('edit.name') } }, [_c('label', { staticClass: "control-label", attrs: { "for": "edit.name" } }, [_vm._v("公司名称:")]), _vm._v(" "), _c('input', { directives: [{ name: "validate", rawName: "v-validate", value: { required: true, min: 2 }, expression: "{required:true,min:2}" }, { name: "model", rawName: "v-model", value: _vm.editObj.name, expression: "editObj.name" }], staticClass: "form-control", attrs: { "type": "text", "name": "edit.name", "id": "edit.name", "placeholder": "输入名称" }, domProps: { "value": _vm.editObj.name }, on: { "input": function input($event) {
          if ($event.target.composing) {
            return;
          }_vm.$set(_vm.editObj, "name", $event.target.value);
        } } }), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('edit.name:required'), expression: "errors.has('edit.name:required')" }], staticClass: "text-danger" }, [_vm._v("公司名称不能为空！")]), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('edit.name:min'), expression: "errors.has('edit.name:min')" }], staticClass: "text-danger" }, [_vm._v("公司名称最小长度为2位！")])]), _vm._v(" "), _c('div', { staticClass: "form-group has-feedback", class: { ' has-error': _vm.errors.has('edit.order') } }, [_c('label', { staticClass: "control-label", attrs: { "for": "edit.order" } }, [_vm._v("排序:")]), _vm._v(" "), _c('input', { directives: [{ name: "validate", rawName: "v-validate", value: { required: true, min_value: 1 }, expression: "{required:true,min_value:1}" }, { name: "model", rawName: "v-model", value: _vm.editObj.order, expression: "editObj.order" }], staticClass: "form-control", attrs: { "type": "text", "name": "edit.order", "id": "edit.order", "placeholder": "输入数值" }, domProps: { "value": _vm.editObj.order }, on: { "input": function input($event) {
          if ($event.target.composing) {
            return;
          }_vm.$set(_vm.editObj, "order", $event.target.value);
        } } }), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('edit.order:required'), expression: "errors.has('edit.order:required')" }], staticClass: "text-danger" }, [_vm._v("排序不为空！")]), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('edit.order:min_value'), expression: "errors.has('edit.order:min_value')" }], staticClass: "text-danger" }, [_vm._v("排序值不能小于1！")])]), _vm._v(" "), _c('div', { staticClass: "form-group has-feedback", class: { ' has-error': _vm.errors.has('edit.tel') } }, [_c('label', { staticClass: "control-label", attrs: { "for": "edit.tel" } }, [_vm._v("联系电话:")]), _vm._v(" "), _c('input', { directives: [{ name: "validate", rawName: "v-validate", value: { required: true, regex: /^\d[0-9-]{4,}$/ }, expression: "{required:true,regex:/^\\d[0-9-]{4,}$/}" }, { name: "model", rawName: "v-model", value: _vm.editObj.tel, expression: "editObj.tel" }], staticClass: "form-control", attrs: { "type": "text", "name": "edit.tel", "id": "edit.tel", "placeholder": "输入数值" }, domProps: { "value": _vm.editObj.tel }, on: { "input": function input($event) {
        ...
        } } }), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('edit.addr:required'), expression: "errors.has('edit.addr:required')" }], staticClass: "text-danger" }, [_vm._v("地址不能为空！")])]), _vm._v(" "), _c('div', { staticClass: "form-group clearfix" }, [_c('div', { staticClass: "col-xs-12 padding-lr-no" }, [_c('label', { staticClass: "control-label", attrs: { "for": "edit.code" } }, [_vm._v("上传图片:")])]), _vm._v(" "), _c('div', { staticClass: "col-sm-6 padding-lr-no" }, [_c('input', { directives: [{ name: "model", rawName: "v-model", value: _vm.editdFileUpload, expression: "editdFileUpload" }], staticClass: "form-control", attrs: { "type": "text", "disabled": "", "name": "", "id": "", "placeholder": "上传图片" }, domProps: { "value": _vm.editdFileUpload }, on: { "input": function input($event) {
          if ($event.target.composing) {
            return;
          }_vm.editdFileUpload = $event.target.value;
        } } })]), _vm._v(" "), _c('div', { staticClass: "col-sm-4" }, [_c('vue-file', { attrs: { "name": "vue-file-edit", "btn-class": "btn-primary", "url": "/file", "ok": _vm.editFileOk, "file-type": "image/*", "size": 300, "timeout": 30, "line-class": "text-primary", "btn-text": "上传图片" } })], 1)]), _vm._v(" "), _c('div', { staticClass: "form-group clearfix" }, [_c('div', { staticClass: "col-xs-6 clearfix" }, _vm._l(_vm.editObj.imgs, function (item, index) {
...
var App$10 = {
  render: function render() {
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('div', { staticClass: "template-share rotation" }, [_c('div', { staticClass: "tab-slide", class: { 'active': _vm.tab.index } }, [_c('div', { staticClass: "btn-toolbar clearfix" }, [_c('div', { staticClass: "btn-group pull-left" }), _vm._v(" "), _c('div', { staticClass: "btn-group pull-right" }, [_c('button', { staticClass: "btn btn-default btn-sm", on: { "click": _vm.addBtn } }, [_c('span', { staticClass: "text-primary glyphicon glyphicon-plus" }), _vm._v(" 添加\n          ")]), _vm._v(" "), _c('button', { staticClass: "btn btn-default btn-sm", on: { "click": _vm.dtlBtn } }, [_c('span', { staticClass: "text-info glyphicon glyphicon-list-alt" }), _vm._v(" 查看\n          ")]), _vm._v(" "), _c('button', { staticClass: "btn btn-default btn-sm", on: { "click": _vm.editBtn } }, [_c('span', { staticClass: "glyphicon glyphicon-edit text-warning" }), _vm._v(" 修改\n          ")]), _vm._v(" "), _c('button', { staticClass: "btn btn-default btn-sm", on: { "click": function click($event) {
        ...
        } }]) }, [_c('template', { slot: "title" }, [_vm._v("查看文章详情")])], 2)], 1), _vm._v(" "), _c('div', { staticClass: "tab-slide", class: { 'active': _vm.tab.add } }, [_c('vue-add', { attrs: { "cancel": _vm.addCancel, "url": _vm.httpUlr.add } }, [_c('template', { slot: "title" }, [_vm._v("添加文章")]), _vm._v(" "), [_c('form', { attrs: { "data-vv-scope": "add" }, on: { "submit": function submit($event) {
          $event.preventDefault();_vm.add('add');
        ...
        } } }), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.desc:required'), expression: "errors.has('add.desc:required')" }], staticClass: "text-danger" }, [_vm._v("描述不能为空！")]), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.desc:min'), expression: "errors.has('add.desc:min')" }], staticClass: "text-danger" }, [_vm._v("描述最小长度为4位！")])]), _vm._v(" "), _c('div', { staticClass: "form-group has-feedback", class: { ' has-error': _vm.errors.has('add.content') } }, [_c('label', { staticClass: "control-label", attrs: { "for": "add.content" } }, [_vm._v("文章内容:")]), _vm._v(" "), _c('input', { directives: [{ name: "validate", rawName: "v-validate", value: { required: true }, expression: "{required:true}" }, { name: "model", rawName: "v-model", value: _vm.addObj.content, expression: "addObj.content" }], staticClass: "form-control v-hide", attrs: { "type": "text", "name": "add.content", "id": "add.content", "placeholder": "输入数值" }, domProps: { "value": _vm.addObj.content }, on: { "input": function input($event) {
          if ($event.target.composing) {
            return;
          }_vm.$set(_vm.addObj, "content", $event.target.value);
        } } }), _vm._v(" "), _c('script', { staticStyle: { "width": "100%", "height": "200px" }, attrs: { "id": "add-editor", "type": "text/plain" } }), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('add.content:required'), expression: "errors.has('add.content:required')" }], staticClass: "text-danger" }, [_vm._v("文章内容不能为空！")])]), _vm._v(" "), _c('div', { staticClass: "form-group" }, [_c('button', { staticClass: "btn btn-primary", attrs: { "type": "submit", "disabled": _vm.addError } }, [_vm._v("添加")])])])]], 2)], 1), _vm._v(" "), _c('div', { staticClass: "tab-slide", class: { 'active': _vm.tab.edit } }, [_c('vue-edit', { attrs: { "cancel": _vm.editCancel, "url": _vm.httpUlr.edit } }, [_c('template', { slot: "title" }, [_vm._v("修改文章")]), _vm._v(" "), [_c('form', { attrs: { "data-vv-scope": "edit" }, on: { "submit": function submit($event) {
          $event.preventDefault();_vm.edit('edit');
        ...
        } } }), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('edit.desc:required'), expression: "errors.has('edit.desc:required')" }], staticClass: "text-danger" }, [_vm._v("描述不能为空！")]), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('edit.desc:min'), expression: "errors.has('edit.desc:min')" }], staticClass: "text-danger" }, [_vm._v("描述最小长度为4位！")])]), _vm._v(" "), _c('div', { staticClass: "form-group has-feedback", class: { ' has-error': _vm.errors.has('edit.content') } }, [_c('label', { staticClass: "control-label", attrs: { "for": "edit.content" } }, [_vm._v("文章内容:")]), _vm._v(" "), _c('script', { staticStyle: { "width": "100%", "height": "200px" }, attrs: { "id": "edit-editor", "type": "text/plain" } }), _vm._v(" "), _c('input', { directives: [{ name: "validate", rawName: "v-validate", value: { required: true }, expression: "{required:true}" }, { name: "model", rawName: "v-model", value: _vm.editObj.content, expression: "editObj.content" }], staticClass: "form-control v-hide", attrs: { "type": "text", "name": "edit.content", "id": "edit.content", "placeholder": "输入数值" }, domProps: { "value": _vm.editObj.content }, on: { "input": function input($event) {
          if ($event.target.composing) {
            return;
          }_vm.$set(_vm.editObj, "content", $event.target.value);
        } } }), _vm._v(" "), _c('p', { directives: [{ name: "show", rawName: "v-show", value: _vm.errors.has('edit.content:required'), expression: "errors.has('edit.content:required')" }], staticClass: "text-danger" }, [_vm._v("文章内容不能为空！")])]), _vm._v(" "), _c('div', { staticClass: "form-group" }, [_c('button', { staticClass: "btn btn-primary", attrs: { "type": "submit", "disabled": _vm.editError } }, [_vm._v("保存")])])])]], 2)], 1)]);
  },
  staticRenderFns: [],
  mixins: [mixin$1],
  data: function data() {
...
var App$11 = {
  render: function render() {
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('div', { staticClass: "file" }, [_c('hr'), _vm._v(" "), _c('div', { staticClass: "form-group" }, [_c('div', { staticClass: "col-sm-6" }, [_c('input', { directives: [{ name: "model", rawName: "v-model", value: _vm.file.data, expression: "file.data" }], staticClass: "form-control", attrs: { "type": "text", "name": "", "id": "" }, domProps: { "value": _vm.file.data }, on: { "input": function input($event) {
        ...
        } } })]), _vm._v(" "), _c('div', { staticClass: "col-sm-4" }, [_c('vue-file', { attrs: { "name": "vue-file-up", "btn-class": "btn-primary", "url": "http://localhost:3000/file", "ok": _vm.ok, "err": _vm.err, "file-type": "image/*", "size": 300, "timeout": 30, "line-class": "text-primary", "btn-text": "上传图片" }, model: { value: _vm.file, callback: function callback($$v) {
          _vm.file = $$v;
